...
<html>
	...
	<c:choose>
		<c:when test="${from eq 'lib' }">
			<h5>EForm view &nbsp;<a href='<c:url value="/eformConfiguration/" />' class="btn btn-primary">EXIT</a></h5>
		</c:when>
		<c:otherwise>
			<h5>EForm view &nbsp;<a href='<c:url value="/eformConfiguration/" />' class="btn btn-primary">EXIT</a></h5>
		</c:otherwise>
		...
		<br/>
		<div style="text-align:center"><a href='<c:url value="/eformConfiguration/" />' class="btn btn-primary">EXIT</a></div>
</body>
