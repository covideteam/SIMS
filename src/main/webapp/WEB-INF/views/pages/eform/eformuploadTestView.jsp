...
<%@ taglib prefix="sf" uri="http://www.springframework.org/tags/form"%>
	<h5>Activity Preview</h5>
		<h6 class="box-title">
    	Name : ${crfviewTest.name }&nbsp;&nbsp;&nbsp;&nbsp;
    	Desc : ${crfviewTest.title }&nbsp;&nbsp;&nbsp;&nbsp;
    	TYPE : ${crfviewTest.type }&nbsp;&nbsp;&nbsp;&nbsp;<BR/>
    	GENDER : ${crfviewTest.gender }&nbsp;&nbsp;&nbsp;&nbsp;
    	VERSION : ${crfviewTest.version }&nbsp;&nbsp;&nbsp;&nbsp;</h6>
            <div class="box-body" oncontextmenu="return false;">
            	<c:forEach items="${crfviewTest.sections}" var="sec">
															...
															<tr>
																...
																<c:if test="${item.totalDesc eq ''}">
																	...
																	<td><c:choose>
																			...
																			<c:when test="${item.type eq 'selectTable'}">
																				<select class="form-control" name="${itemkey}" id="${itemkey}"
																					onchange="textOnChangeSec('${item.id}','${itemkey}', this.value, 'select')">
																					<option value="-1">--Select--</option>
																				</select>
		...
		<br/>
		<c:url value="/eformConfiguration/crfuploadsave" var="crfuploadsaveUrl" />		
		<sf:form action="${crfuploadsaveUrl}" method="GET" modelAttribute="crfpojo"
    		id="crfuploadsave" enctype="multipart/form-data">
            <div style="text-align:center">
            	<input type="button" value="SAVE" id="formSubmitBtn" class="btn btn-primary" onclick="formSubmidtBtn()">
            	
            	<a href='<c:url value="/eformConfiguration/" />' class="btn btn-primary">EXIT</a>
            </div>
    	</sf:form>
</body>
