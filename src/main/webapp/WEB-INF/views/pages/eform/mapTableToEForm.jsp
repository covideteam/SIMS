...
<body oncontextmenu="return false;">
	<div class="card">
	<c:url value="/eformConfiguration/mapTableToEFormSave" var="crfRuleSave" />
	<sf:form action="${crfRuleSave}" method="POST" id="crfSave"
		enctype="multipart/form-data">
		<div class="card-header">
			<h3 class="card-title">Map DB to EForm</h3>
		</div>
		<div class="card-body">
			<div class="row">
				<div class="col-sm-4">
					...
					<div class="form-group">
						<label>Select EForm</label> <select class="form-control"
...
function crfIdChange(id){
	if(id == -1){
		...
		var result = synchronousAjaxCall(mainUrl+"/eformConfiguration/eformSectionElementsSelectTable/"+id);
...
function tableChange(id){
	if(id == -1){
		...
		var result = synchronousAjaxCall(mainUrl+"/eformConfiguration/eformMappingTableColumns/"+id);
		if(result != '' || result != 'undefined'){
