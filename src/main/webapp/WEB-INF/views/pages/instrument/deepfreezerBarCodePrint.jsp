...
<div class="row" oncontextmenu="return false;">
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			<div class="x_title">
				<h2><spring:message code="label.deepfreezer.printHedding"></spring:message></h2>
				...
				<table id="example1" class="table table-bordered table-striped"
					...
					<thead>
						<tr>
							...
							<th><spring:message code="label.deepfreezer.rackNo"></spring:message></th>
					...
					<tbody>
						<c:forEach items="${list}" var="li" varStatus="st">
							<tr>
								...
								<td align="center">
									<a href='<c:url value="/barcodelabels/deepfreezerBarCodePrint/${li.id}"/>'>
									<i class="fa fa-barcode" style="font-size: 15px; font-weight: bold;"></i></a>
								</td>
