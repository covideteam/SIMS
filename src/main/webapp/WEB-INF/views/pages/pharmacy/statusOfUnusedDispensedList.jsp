...
<script type="text/javascript">
		...
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				...
				<div class="x_content">
					<br>
            <a  style='float:right;' href='<c:url value="/pharmacyData/statusOfUnusedDispensedForm"/>' ><button type="button" class="btn btn-info"><spring:message code="label.addBt"></spring:message></button></a>
              
            <table id="drugList"  class="table table-striped table-bordered nowrap" style="width: 100%;">
                <thead>
	                <tr>
	                	<th><spring:message code="label.statusOfUnusedDispensed.projectNo"></spring:message></th>
	                </tr>
                </thead>
                <tbody>
