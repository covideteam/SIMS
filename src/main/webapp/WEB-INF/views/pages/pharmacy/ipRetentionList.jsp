...
<script type="text/javascript">
		...
		<div class="col-md-12 col-sm-12 ">
			<div class="x_panel">
				...
				<div class="x_content">
					<br>
            <a  style='float:right;' href='<c:url value="/pharmacyData/ipRetentionForm"/>' ><button type="button" class="btn btn-info"><spring:message code="label.addBt"></spring:message></button></a>
