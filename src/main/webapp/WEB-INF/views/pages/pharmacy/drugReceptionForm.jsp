...
<title>Drug Reception Form</title>
...
<!--         <div style="margin-left: 25%; width: 65%;"> -->
        	<c:url value="/drugReception/saveDrugReception" var="saveData"></c:url>
        	...
        	<label for="workingAreaClean" class="col-form-label" style="color: #212529;">a.<spring:message code="label.drungreception.workingAreaClean"></spring:message></label>
        	</td>
        	<td style="padding-top:20px"> 
        	...
        	<td > 
        	<label for="areaClean_yes" class="col-form-label" style="color: #212529;">b.<spring:message code="label.drungreception.areaClean"></spring:message></label>
        	</td>
        	<td> 
        	...
        	<tr>
        	<td colspan="2" id="rqdoc"> 
        	<label for="requiredDocumentsAvailable" class="col-form-label" style="color: #212529;">c.<spring:message code="label.drungreception.requiredDocumentsAvailable"></spring:message></label>
        	</td>
        	<td> 
           ...
           <td><label for="numberofContainersNotOpened" class= "col-form-label" style ="color:#212529;"><spring:message code="label.drugreception.numberofContainersNotOpened"></spring:message></label></td>
        	...
        	<td> 
        	  ...
        	  <form:select  path="productPharmaceuticalForm" id="pharmaceuticalForm" onchange="pharmaceuticalFormValidation('pharmaceuticalForm','pharmaceuticalFormMsg')" autocomplete="off" Class="form-control autosave reviewElement validate" data-validate="required">
        	             <form:option value="-1">----<spring:message code="label.ruleSelect"></spring:message>----</form:option>
        	             <form:option value="Product"><spring:message code="label.product"></spring:message></form:option> 
        	             <form:option value="Reference"><spring:message code="label.ipDiscard.reference"></spring:message></form:option>
        	  </form:select>
        	...
        	<td> 
			  ...
			  <input type="checkbox" name="shippingConditions" id="shippingCoditionsno" value="Damaged" onclick="shippingCoditionsValidation()"><label class="col-form-label" for="shippingCoditionsno" style="color:#212529; "><spring:message code="label.drugreception.damaged"></spring:message></label>
        	...
        	<td colspan="2"> 
        	<label>
        	   <input type="checkbox" name="containerSleCondition" id="containerSealConditionIntact" value="Intact" onclick="containerSealConditionValidation()" required><label class="col-form-label" for="containerSealConditionIntact" style="color:#212529; "><spring:message code="label.drugreception.intact"></spring:message></label>
			  <input type="checkbox" name="containerSleCondition" id="containerSealConditionNoseal" value="NoSeal" onclick="containerSealConditionValidation()"><label class="col-form-label" for="containerSealConditionNoseal" style="color:#212529; "><spring:message code="label.drugreception.noSeal"></spring:message></label>
        ...
        /* $("#noofBoxsLabel").on('change', function(e) {
           ...
           function shippingCoditionsValidation(){
			...
			function theLabelOfTheDrugProductContainsValidation(){
			 ...
			 function condition(){
        		...
        		if($('#workingAreaClean_yes').prop("checked")==true&&$('#requiredDocumentsAvailable_yes').prop("checked")==true&&$('#areaClean_yes').prop("checked")==true){
        			$(".acCon").show();
        			$("#rqdoc").attr('colspan', 0);
        		}else{
        			$(".acCon").hide();
        			$("#rqdoc").attr('colspan', 2);
        		}
        	} 
        	...
        	function submitFunctionData(){
        		...
        		var projAvailable =projectAvailableValidation()
        		...
        		if(validation.validate($('#saveForm')[0])&&projFlag&&aRFlag&&dPTFlag&&sUFlag&&phrFlag&&wAFlag&&rDaFlag&&qRFlag&&pCFLag&&uUFlag&&pCRFlag&&dLFlag&&sCCFlag&&cSCFlag&&sCFlag&&areaFlaf
        				...
        				&&purchaseinvoice&&expirationdate&&quantity&&batchlotnum&&transferletter&&prodforanotherproduct){
        			//alert("okk working");
        			if($('#projectAvailable_yes').prop("checked")){
        				 $("#projectnoMsg").html("");
        				 $("#randamizationCodeMsg").html("");
