...
public class HeaderAndFooterForAdvFirstCoverPage extends PdfPageEventHelper {
	...
	private PdfPTable footTab;
	
	public HeaderAndFooterForAdvFirstCoverPage(String imagePath, String studyName, String periodNo, UserMaster user, String dateStr, Font regular, Font heading, StudyVolunteerReporting svr, MessageSource messageSource, Locale currentLocale, Font mainHeading,
			DataCrfDtoDetails dcdDto, String dateStrWithTime, PdfPTable footTab) {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
		try {
            ...
            footTab.writeSelectedRows(0, -1, 36, 150, cb);
