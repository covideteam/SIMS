...
import com.covideinfo.audittrail.AuditInterceptor;

@Configuration
@EnableTransactionManagement
@ComponentScan({ "com.covideinfo.configuration", "com.covideinfo.security"  })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] {  "com.covideinfo.model","com.covideinfo.eform.model" });
...
/*    @Bean
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("hibernate.format_sql", environment.getRequiredProperty("hibernate.format_sql"));
        properties.put("hibernate.dialect", environment.getRequiredProperty("hibernate.dialect"));
        properties.put("hibernate.default_schema", environment.getRequiredProperty("schema"));
        properties.put("hibernate.hbm2ddl.auto", environment.getRequiredProperty("hibernate.hbm2ddl.auto"));
