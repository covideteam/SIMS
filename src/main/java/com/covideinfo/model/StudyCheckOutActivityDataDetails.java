...
@Entity
@Table(name="study_activity_data_check_out")
public class StudyCheckOutActivityDataDetails implements Serializable {

	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="study_check_out_activity_data_details_id_seq", allocationSize=1)
