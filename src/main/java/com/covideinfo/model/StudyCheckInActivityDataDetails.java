...
@Entity
@Table(name="study_activity_data_check_in")
public class StudyCheckInActivityDataDetails implements Serializable {

	
	private static final long serialVersionUID = -3612149924566853436L;
	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="study_check_in_activity_data_details_id_seq", allocationSize=1)
