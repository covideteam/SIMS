...
@Entity
@Table(name = "Randomization_Review_Audit")
public class RandomizationReviewAudit {
	@Id
	@SequenceGenerator(name="pk_sequence",sequenceName="Randomization_Review_Audit_id_seq", allocationSize=1)
