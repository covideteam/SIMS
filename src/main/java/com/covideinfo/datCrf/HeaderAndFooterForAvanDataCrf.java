...
public class HeaderAndFooterForAvanDataCrf extends PdfPageEventHelper {
	...
	private DataCrfDtoDetails dcdDto;
	...
	public HeaderAndFooterForAvanDataCrf(String imagePath,DataCrfDtoDetails dcdDto, String dateStr, Font regular, Font heading, Font mainHeading, Font subHeading, String periodNo, MessageSource messageSource, Locale currentLocale, StudyVolunteerReporting svr, String dateStrWithTime) {
		this.imgLoc = imagePath;
		this.user = dcdDto.getUser();
...
//            Font bold = new Font(FontFamily.TIMES_ROMAN, 16, Font.BOLD);
    		...
    		if(dcdDto.getStudy() !=null)
    			headStr = headStr+" : " +dcdDto.getStudy().getProjectNo();
    		else 
    			headStr = headStr+" : ";
...
//    		cell.setPadding(7f);
    		...
    		headStr = headStr+" : ";
    		if(subject != null)
    			cell = new PdfPCell(new Phrase(headStr.trim()+subject.getSubjectNo(), subHeading));
    		else 
...
//    		cell.setPadding(7f);
    		...
    		headStr = headStr+" : ";
    		if(dcdDto.getStudy() != null)
    			cell = new PdfPCell(new Phrase(headStr.trim()+" "+dcdDto.getStudy().getSponsorCode(), subHeading));
    		else cell = new PdfPCell(new Phrase(headStr.trim(), subHeading));
    		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
    		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
    		cell.setBorderColor(new BaseColor(73, 74, 82)); //##494c52
    		cell.setPaddingTop(3f);
...
//    		headStr = versionheadStr+" : 01, "+" \n"+dateHeadStr+" : ";
    		...
    		cell = new PdfPCell(new Phrase(headStr, subHeading));
    		cell.setHorizontalAlignment(Element.ALIGN_LEFT);
    		cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
    		cell.setPaddingTop(3f);
		    cell.setPaddingBottom(7f);
